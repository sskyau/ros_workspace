...
echo_and_run cd "/home/skyau/ros_workspace/src/gazebo_ros_pkgs/gazebo_ros"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/skyau/ros_workspace/src/gazebo_ros_pkgs/gazebo_ros/setup.py" \
     \
    build --build-base "/home/skyau/ros_workspace/build/gazebo_ros_pkgs/gazebo_ros" \
    install \
    --root="${DESTDIR-/}" \
