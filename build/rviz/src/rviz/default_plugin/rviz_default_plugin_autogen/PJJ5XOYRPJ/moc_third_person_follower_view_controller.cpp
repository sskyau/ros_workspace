...
struct qt_meta_stringdata_rviz__ThirdPersonFollowerViewController_t {
    QByteArrayData data[1];
    char stringdata0[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__ThirdPersonFollowerViewController_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__ThirdPersonFollowerViewController_t qt_meta_stringdata_rviz__ThirdPersonFollowerViewController = {
    {
QT_MOC_LITERAL(0, 0, 39) // "rviz::ThirdPersonFollowerView..."
...
const QMetaObject rviz::ThirdPersonFollowerViewController::staticMetaObject = {
    { &OrbitViewController::staticMetaObject, qt_meta_stringdata_rviz__ThirdPersonFollowerViewController.data,
      qt_meta_data_rviz__ThirdPersonFollowerViewController,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::ThirdPersonFollowerViewController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ThirdPersonFollowerViewController.stringdata0))
