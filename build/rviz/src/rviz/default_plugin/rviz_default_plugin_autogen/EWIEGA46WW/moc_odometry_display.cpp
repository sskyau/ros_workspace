...
struct qt_meta_stringdata_rviz__OdometryDisplay_t {
    QByteArrayData data[7];
    char stringdata0[123];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__OdometryDisplay_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__OdometryDisplay_t qt_meta_stringdata_rviz__OdometryDisplay = {
    {
QT_MOC_LITERAL(0, 0, 21), // "rviz::OdometryDisplay"
QT_MOC_LITERAL(1, 22, 17), // "updateShapeChoice"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 21), // "updateShapeVisibility"
QT_MOC_LITERAL(4, 63, 19), // "updateColorAndAlpha"
QT_MOC_LITERAL(5, 83, 20), // "updateArrowsGeometry"
QT_MOC_LITERAL(6, 104, 18) // "updateAxisGeometry"

    },
    "rviz::OdometryDisplay\0updateShapeChoice\0"
    "\0updateShapeVisibility\0updateColorAndAlpha\0"
    "updateArrowsGeometry\0updateAxisGeometry"
};
...
const QMetaObject rviz::OdometryDisplay::staticMetaObject = {
    { &rviz::MessageFilterDisplay<nav_msgs::Odometry>::staticMetaObject, qt_meta_stringdata_rviz__OdometryDisplay.data,
      qt_meta_data_rviz__OdometryDisplay,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::OdometryDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__OdometryDisplay.stringdata0))
