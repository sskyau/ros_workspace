...
struct qt_meta_stringdata_rviz__CameraDisplay_t {
    QByteArrayData data[5];
    char stringdata0[61];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__CameraDisplay_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__CameraDisplay_t qt_meta_stringdata_rviz__CameraDisplay = {
    {
QT_MOC_LITERAL(0, 0, 19), // "rviz::CameraDisplay"
QT_MOC_LITERAL(1, 20, 11), // "forceRender"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 11), // "updateAlpha"
QT_MOC_LITERAL(4, 45, 15) // "updateQueueSize"

    },
    "rviz::CameraDisplay\0forceRender\0\0"
    "updateAlpha\0updateQueueSize"
};
...
const QMetaObject rviz::CameraDisplay::staticMetaObject = {
    { &ImageDisplayBase::staticMetaObject, qt_meta_stringdata_rviz__CameraDisplay.data,
      qt_meta_data_rviz__CameraDisplay,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::CameraDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__CameraDisplay.stringdata0))
