...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_rviz__CovarianceProperty_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__CovarianceProperty_t qt_meta_stringdata_rviz__CovarianceProperty = {
    {
QT_MOC_LITERAL(0, 0, 24), // "rviz::CovarianceProperty"
QT_MOC_LITERAL(1, 25, 16), // "updateVisibility"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 36), // "updateColorAndAlphaAndScaleAn..."
QT_MOC_LITERAL(4, 80, 22), // "updateOrientationFrame"
QT_MOC_LITERAL(5, 103, 22) // "updateColorStyleChoice"

    },
    "rviz::CovarianceProperty\0updateVisibility\0"
    "\0updateColorAndAlphaAndScaleAndOffset\0"
    "updateOrientationFrame\0updateColorStyleChoice"
};
...
const QMetaObject rviz::CovarianceProperty::staticMetaObject = {
    { &rviz::BoolProperty::staticMetaObject, qt_meta_stringdata_rviz__CovarianceProperty.data,
      qt_meta_data_rviz__CovarianceProperty,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::CovarianceProperty::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__CovarianceProperty.stringdata0))
