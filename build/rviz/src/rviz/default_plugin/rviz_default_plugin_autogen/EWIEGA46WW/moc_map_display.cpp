...
QT_MOC_LITERAL(1, 17, 10), // "mapUpdated"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11), // "updateAlpha"
QT_MOC_LITERAL(4, 41, 11), // "updateTopic"
QT_MOC_LITERAL(5, 53, 15), // "updateDrawUnder"
QT_MOC_LITERAL(6, 69, 13), // "updatePalette"
QT_MOC_LITERAL(7, 83, 7), // "showMap"
QT_MOC_LITERAL(8, 91, 12) // "transformMap"

    },
    "rviz::MapDisplay\0mapUpdated\0\0updateAlpha\0"
    "updateTopic\0updateDrawUnder\0updatePalette\0"
    "showMap\0transformMap"
};
...
void rviz::MapDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MapDisplay::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapDisplay::mapUpdated)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject rviz::MapDisplay::staticMetaObject = {
    { &Display::staticMetaObject, qt_meta_stringdata_rviz__MapDisplay.data,
      qt_meta_data_rviz__MapDisplay,  qt_static_metacall, nullptr, nullptr}
};
