...
struct qt_meta_stringdata_rviz__MarkerDisplay_t {
    QByteArrayData data[4];
    char stringdata0[49];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__MarkerDisplay_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__MarkerDisplay_t qt_meta_stringdata_rviz__MarkerDisplay = {
    {
QT_MOC_LITERAL(0, 0, 19), // "rviz::MarkerDisplay"
QT_MOC_LITERAL(1, 20, 15), // "updateQueueSize"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 11) // "updateTopic"
...
const QMetaObject rviz::MarkerDisplay::staticMetaObject = {
    { &Display::staticMetaObject, qt_meta_stringdata_rviz__MarkerDisplay.data,
      qt_meta_data_rviz__MarkerDisplay,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::MarkerDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__MarkerDisplay.stringdata0))
...
struct qt_meta_stringdata_rviz__MarkerNamespace_t {
    QByteArrayData data[3];
    char stringdata0[39];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__MarkerNamespace_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__MarkerNamespace_t qt_meta_stringdata_rviz__MarkerNamespace = {
    {
QT_MOC_LITERAL(0, 0, 21), // "rviz::MarkerNamespace"
QT_MOC_LITERAL(1, 22, 15), // "onEnableChanged"
...
const QMetaObject rviz::MarkerNamespace::staticMetaObject = {
    { &BoolProperty::staticMetaObject, qt_meta_stringdata_rviz__MarkerNamespace.data,
      qt_meta_data_rviz__MarkerNamespace,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_rviz__MarkerNamespace.stringdata0))
        return static_cast<void*>(this);
