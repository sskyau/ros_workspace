...
#include "../../../../../../../src/rviz/src/rviz/default_plugin/axes_display.h"
...
struct qt_meta_stringdata_rviz__AxesDisplay_t {
    QByteArrayData data[3];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__AxesDisplay_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__AxesDisplay_t qt_meta_stringdata_rviz__AxesDisplay = {
    {
QT_MOC_LITERAL(0, 0, 17), // "rviz::AxesDisplay"
QT_MOC_LITERAL(1, 18, 11), // "updateShape"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "rviz::AxesDisplay\0updateShape\0"
};
...
const QMetaObject rviz::AxesDisplay::staticMetaObject = {
    { &Display::staticMetaObject, qt_meta_stringdata_rviz__AxesDisplay.data,
      qt_meta_data_rviz__AxesDisplay,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::AxesDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__AxesDisplay.stringdata0))
