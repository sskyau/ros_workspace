...
struct qt_meta_stringdata_rviz__IntegerAction_t {
    QByteArrayData data[5];
    char stringdata0[41];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__IntegerAction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__IntegerAction_t qt_meta_stringdata_rviz__IntegerAction = {
    {
QT_MOC_LITERAL(0, 0, 19), // "rviz::IntegerAction"
QT_MOC_LITERAL(1, 20, 9), // "triggered"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 2), // "id"
QT_MOC_LITERAL(4, 34, 6) // "emitId"

    },
    "rviz::IntegerAction\0triggered\0\0id\0"
    "emitId"
};
...
void rviz::IntegerAction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (IntegerAction::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IntegerAction::triggered)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject rviz::IntegerAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_rviz__IntegerAction.data,
      qt_meta_data_rviz__IntegerAction,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::IntegerAction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__IntegerAction.stringdata0))
