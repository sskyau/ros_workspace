...
struct qt_meta_stringdata_rviz__ComboBox_t {
    QByteArrayData data[2];
    char stringdata0[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__ComboBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__ComboBox_t qt_meta_stringdata_rviz__ComboBox = {
    {
QT_MOC_LITERAL(0, 0, 14), // "rviz::ComboBox"
QT_MOC_LITERAL(1, 15, 11) // "currentText"

    },
    "rviz::ComboBox\0currentText"
};
...
const QMetaObject rviz::ComboBox::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_rviz__ComboBox.data,
      qt_meta_data_rviz__ComboBox,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::ComboBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ComboBox.stringdata0))
