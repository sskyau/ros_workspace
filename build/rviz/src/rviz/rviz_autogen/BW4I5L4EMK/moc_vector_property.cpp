...
struct qt_meta_stringdata_rviz__VectorProperty_t {
    QByteArrayData data[4];
    char stringdata0[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__VectorProperty_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__VectorProperty_t qt_meta_stringdata_rviz__VectorProperty = {
    {
QT_MOC_LITERAL(0, 0, 20), // "rviz::VectorProperty"
QT_MOC_LITERAL(1, 21, 18), // "updateFromChildren"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 17) // "emitAboutToChange"
...
const QMetaObject rviz::VectorProperty::staticMetaObject = {
    { &Property::staticMetaObject, qt_meta_stringdata_rviz__VectorProperty.data,
      qt_meta_data_rviz__VectorProperty,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::VectorProperty::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__VectorProperty.stringdata0))
