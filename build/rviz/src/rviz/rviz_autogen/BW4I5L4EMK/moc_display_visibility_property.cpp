...
#include "../../../../../../src/rviz/src/rviz/properties/display_visibility_property.h"
...
struct qt_meta_stringdata_rviz__DisplayVisibilityProperty_t {
    QByteArrayData data[4];
    char stringdata0[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__DisplayVisibilityProperty_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__DisplayVisibilityProperty_t qt_meta_stringdata_rviz__DisplayVisibilityProperty = {
    {
QT_MOC_LITERAL(0, 0, 31), // "rviz::DisplayVisibilityProperty"
QT_MOC_LITERAL(1, 32, 8), // "setValue"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 9) // "new_value"

    },
    "rviz::DisplayVisibilityProperty\0"
...
const QMetaObject rviz::DisplayVisibilityProperty::staticMetaObject = {
    { &BoolProperty::staticMetaObject, qt_meta_stringdata_rviz__DisplayVisibilityProperty.data,
      qt_meta_data_rviz__DisplayVisibilityProperty,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::DisplayVisibilityProperty::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__DisplayVisibilityProperty.stringdata0))
