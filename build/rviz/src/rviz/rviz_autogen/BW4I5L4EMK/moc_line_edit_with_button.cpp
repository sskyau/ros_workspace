...
#include "../../../../../../src/rviz/src/rviz/properties/line_edit_with_button.h"
...
void rviz::LineEditWithButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LineEditWithButton *_t = static_cast<LineEditWithButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject rviz::LineEditWithButton::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_rviz__LineEditWithButton.data,
      qt_meta_data_rviz__LineEditWithButton,  qt_static_metacall, nullptr, nullptr}
};
