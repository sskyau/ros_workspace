...
struct qt_meta_stringdata_rviz__ColorEditor_t {
    QByteArrayData data[6];
    char stringdata0[58];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__ColorEditor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__ColorEditor_t qt_meta_stringdata_rviz__ColorEditor = {
    {
QT_MOC_LITERAL(0, 0, 17), // "rviz::ColorEditor"
QT_MOC_LITERAL(1, 18, 8), // "setColor"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5), // "color"
QT_MOC_LITERAL(4, 34, 9), // "parseText"
QT_MOC_LITERAL(5, 44, 13) // "onButtonClick"

    },
    "rviz::ColorEditor\0setColor\0\0color\0"
    "parseText\0onButtonClick"
};
...
const QMetaObject rviz::ColorEditor::staticMetaObject = {
    { &LineEditWithButton::staticMetaObject, qt_meta_stringdata_rviz__ColorEditor.data,
      qt_meta_data_rviz__ColorEditor,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::ColorEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__ColorEditor.stringdata0))
