...
struct qt_meta_stringdata_rviz__Robot_t {
    QByteArrayData data[8];
    char stringdata0[150];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__Robot_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__Robot_t qt_meta_stringdata_rviz__Robot = {
    {
QT_MOC_LITERAL(0, 0, 11), // "rviz::Robot"
QT_MOC_LITERAL(1, 12, 20), // "changedLinkTreeStyle"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 17), // "changedExpandTree"
QT_MOC_LITERAL(4, 52, 24), // "changedHideSubProperties"
QT_MOC_LITERAL(5, 77, 21), // "changedEnableAllLinks"
QT_MOC_LITERAL(6, 99, 24), // "changedExpandLinkDetails"
QT_MOC_LITERAL(7, 124, 25) // "changedExpandJointDetails"

    },
    "rviz::Robot\0changedLinkTreeStyle\0\0"
    "changedExpandTree\0changedHideSubProperties\0"
    "changedEnableAllLinks\0changedExpandLinkDetails\0"
...
const QMetaObject rviz::Robot::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__Robot.data,
      qt_meta_data_rviz__Robot,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::Robot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__Robot.stringdata0))
