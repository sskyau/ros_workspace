...
struct qt_meta_stringdata_rviz__Tool_t {
    QByteArrayData data[5];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__Tool_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__Tool_t qt_meta_stringdata_rviz__Tool = {
    {
QT_MOC_LITERAL(0, 0, 10), // "rviz::Tool"
QT_MOC_LITERAL(1, 11, 5), // "close"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 11), // "nameChanged"
QT_MOC_LITERAL(4, 30, 4) // "name"

    },
    "rviz::Tool\0close\0\0nameChanged\0name"
};
...
void rviz::Tool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Tool::*_t)(const QString & );
...
const QMetaObject rviz::Tool::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rviz__Tool.data,
      qt_meta_data_rviz__Tool,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::Tool::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__Tool.stringdata0))
...
// SIGNAL 1
void rviz::Tool::nameChanged(const QString & _t1)
{
