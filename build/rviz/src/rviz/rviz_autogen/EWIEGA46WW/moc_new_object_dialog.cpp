...
struct qt_meta_stringdata_rviz__NewObjectDialog_t {
    QByteArrayData data[7];
    char stringdata0[93];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__NewObjectDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__NewObjectDialog_t qt_meta_stringdata_rviz__NewObjectDialog = {
    {
QT_MOC_LITERAL(0, 0, 21), // "rviz::NewObjectDialog"
QT_MOC_LITERAL(1, 22, 6), // "accept"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 17), // "onDisplaySelected"
QT_MOC_LITERAL(4, 48, 16), // "QTreeWidgetItem*"
QT_MOC_LITERAL(5, 65, 13), // "selected_item"
QT_MOC_LITERAL(6, 79, 13) // "onNameChanged"

    },
    "rviz::NewObjectDialog\0accept\0\0"
    "onDisplaySelected\0QTreeWidgetItem*\0"
...
const QMetaObject rviz::NewObjectDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_rviz__NewObjectDialog.data,
      qt_meta_data_rviz__NewObjectDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::NewObjectDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__NewObjectDialog.stringdata0))
