/****************************************************************************
** Meta object code from reading C++ file 'connect_test.h'
**
...
#include "../../../../../../src/rviz/src/test/connect_test.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'connect_test.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 18, 9) // "onChanged"

    },
    "MyObject\0changed\0\0onChanged"
};
...
void MyObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyObject::changed)) {
                *result = 0;
                return;
            }
        }
