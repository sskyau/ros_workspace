...
"""autogenerated by genpy from basics/TimerActionResult.msg. Do not edit."""
import codecs
import sys
...
class TimerActionResult(genpy.Message):
  _md5sum = "1f7bff5e4609ae671e2c0dba2b81e678"
  _type = "basics/TimerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','basics/TimerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TimerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = basics.msg.TimerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = basics.msg.TimerResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2iI().pack(_x.result.time_elapsed.secs, _x.result.time_elapsed.nsecs, _x.result.updates_sent))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.time_elapsed.secs, _x.result.time_elapsed.nsecs, _x.result.updates_sent,) = _get_struct_2iI().unpack(str[start:end])
      return self
