...
class TimerActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TimerFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TimerFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TimerActionFeedback(null);
    ...
    data.feedback = TimerFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TimerActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TimerFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TimerFeedback()
    }
...
module.exports = TimerActionFeedback;
