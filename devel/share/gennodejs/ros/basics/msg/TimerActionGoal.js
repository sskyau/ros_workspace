...
class TimerActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TimerGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TimerActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TimerGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TimerGoal()
    }
...
module.exports = TimerActionGoal;
