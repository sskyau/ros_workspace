...
class TimerActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TimerResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TimerActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = TimerResult.Resolve(msg.result)
    }
    else {
      resolved.result = new TimerResult()
    }
...
module.exports = TimerActionResult;
