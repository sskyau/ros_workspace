...
(cl:defmethod cl:initialize-instance :after ((m <TimerFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basics-msg:<TimerFeedback> is deprecated: use basics-msg:TimerFeedback instead.")))
...
(cl:defmethod time_remaining-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader basics-msg:time_remaining-val is deprecated.  Use basics-msg:time_remaining instead.")
  (time_remaining m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimerFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Part 3: the feedback, to be sent periodically by the server during~%# execution.~%#~%# The amount of time that has elapsed from the start~%duration time_elapsed~%# The amount of time remaining until we're done~%duration time_remaining~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimerFeedback)))
  "Returns full string definition for message of type 'TimerFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Part 3: the feedback, to be sent periodically by the server during~%# execution.~%#~%# The amount of time that has elapsed from the start~%duration time_elapsed~%# The amount of time remaining until we're done~%duration time_remaining~%~%~%~%"))
