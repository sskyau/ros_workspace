...
if("TRUE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/skyau/ros_workspace/src/rviz)
  set(rviz_DEVEL_PREFIX /home/skyau/ros_workspace/devel)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/skyau/ros_workspace/install)
...
if(NOT "/home/skyau/ros_workspace/devel/include;/home/skyau/ros_workspace/src/rviz/src;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include " STREQUAL " ")
  set(rviz_INCLUDE_DIRS "")
  set(_include_dirs "/home/skyau/ros_workspace/devel/include;/home/skyau/ros_workspace/src/rviz/src;/usr/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include")
  ...
  elseif(NOT "http://wiki.ros.org/rviz " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'William Woodall <william@osrfoundation.org>, Robert Haschke <rhaschke@techfak.uni-bielefeld.de>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/skyau/ros_workspace/src/rviz/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rviz_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rviz;/usr/lib/x86_64-linux-gnu/libOgreOverlay.so;/usr/lib/x86_64-linux-gnu/libOgreMain.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/x86_64-linux-gnu/libGL.so;/usr/lib/x86_64-linux-gnu/libGLU.so")
...
set(depends "geometry_msgs;image_transport;interactive_markers;laser_geometry;map_msgs;message_filters;message_runtime;nav_msgs;pluginlib;resource_retriever;roscpp;roslib;sensor_msgs;std_msgs;std_srvs;tf;urdf;visualization_msgs")
